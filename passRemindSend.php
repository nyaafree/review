...
パスワード再発行認証キー入力ページ： http://review.nyanta.jp/review/passRemindRecieve.php
認証キー：{$auth_key}
※認証キーの有効期限は30分となります

認証キーを再発行されたい場合は下記ページより再度再発行をお願い致します。
http://review.nyanta.jp/review/passRemindSend.php
...
<div id="contents" class="site-width">
  ...
  <!-- Main -->
  <section id="main" class="pass-remind-modal" >
